...
class solver():
    ...
    def train(self):
        ...
        losses.append(loss)
        print("Save result")
        with open('case1a_non_constrained.pickle', 'wb') as dualfile:
    ...
    def plot(self):
        ...
        obj1_T = self.para.gamma[0, 0] * list_x1[-1] - 0.5 * self.para.Q[0, 0] * pow(
            list_x1[-1] - self.para.S[0, 0] * z1_T, 2.0)
        ...
        #print('E_obj1_T = ', E_obj1_T.numpy(), 'E_obj2_T = ', E_obj2_T.numpy())
        ...
        with open('case1a_non_constrained_ODE.pickle', 'rb') as dualfile2:
            ODE_list_Gamma, ODE_list_Xi, ODE_list_zeta, ODE_list_z, ODE_list_pbar, ODE_list_vbar = pickle.load(dualfile2)
